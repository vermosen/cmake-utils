...
# create the makevars based on the cmake/conan project content
function(r_create_makevars)

	set(options LTO)
	set(oneValueArgs DIALECT BUILD_TYPE OUT)
	set(multiValueArgs PACKAGES)

	cmake_parse_arguments(
		R_CREATE_MAKEVARS "${options}"
		"${oneValueArgs}" "${multiValueArgs}" ${ARGN})

	if (${R_CREATE_MAKEVARS_BUILD_TYPE} STREQUAL "Debug")
		set(R_EXTRA_COMPILER_FLAG "-O0 -g -DDEBUG")
		set(R_EXTRA_LINKER_FLAG "")
	elseif(${R_CREATE_MAKEVARS_BUILD_TYPE} STREQUAL "Release")

		set(R_EXTRA_COMPILER_FLAG "-O2 -DNDEBUG")

		if (R_CREATE_MAKEVARS_LTO)
			set(R_EXTRA_COMPILER_FLAG " -flto ${R_EXTRA_COMPILER_FLAG}")
			set(R_EXTRA_LINKER_FLAG "-flto")
		else()
			set(R_EXTRA_LINKER_FLAG "")
		endif()
	endif()
	...
	set(R_INCLUDE_LIBS_STR "-std=c++${R_CREATE_MAKEVARS_DIALECT} ${R_EXTRA_COMPILER_FLAG} -I ../inst/include -I \"${PROJECT_SOURCE_DIR}/src\"")
	set(R_LINKER_STR "${R_EXTRA_LINKER_FLAG} -L${PROJECT_BINARY_DIR}/lib ")
	set(R_LINKED_LIBS_STR "")
	...
	set(${R_CREATE_MAKEVARS_OUT} "PKG_CPPFLAGS=${R_INCLUDE_LIBS_STR}\nPKG_LIBS=${R_LINKER_STR} ${R_LINKED_LIBS_STR}" PARENT_SCOPE)

endfunction()


# create the package skeletton	
function(r_create_package_target)

	set(options)
	set(oneValueArgs NAME SOURCE_DIRECTORY BUILD_DIRECTORY PACKAGE MAKEVARS DESCRIPTION )
	set(multiValueArgs)

	cmake_parse_arguments(
		R_CREATE_PACKAGE_TARGET "${options}"
		"${oneValueArgs}" "${multiValueArgs}" ${ARGN})

	# step 1: create the package skeleton
	file(MAKE_DIRECTORY ${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE})
	file(MAKE_DIRECTORY ${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/man)
	file(MAKE_DIRECTORY ${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/R)
	file(MAKE_DIRECTORY ${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/tests/testthat)
	file(MAKE_DIRECTORY ${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/src)
	file(MAKE_DIRECTORY ${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/libs)
	file(MAKE_DIRECTORY ${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/inst/include)

	configure_file(
		${R_CREATE_PACKAGE_TARGET_DESCRIPTION}
		${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/DESCRIPTION
	)

	file(WRITE 
		${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/NAMESPACE
		"# Generated by roxygen2: do not edit by hand\n\nuseDynLib(${R_CREATE_PACKAGE_TARGET_PACKAGE}, .registration=TRUE)"
	)

	file(WRITE
		${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/src/Makevars
		${R_CREATE_PACKAGE_TARGET_MAKEVARS}
	)

	add_custom_target(
		${R_CREATE_PACKAGE_TARGET_NAME} ALL
			COMMAND ${CMAKE_COMMAND} -E copy_directory 
		${R_CREATE_PACKAGE_TARGET_SOURCE_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/R 
		${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/R
			COMMAND ${CMAKE_COMMAND} -E copy_directory
		${R_CREATE_PACKAGE_TARGET_SOURCE_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/src 
		${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/src
			COMMAND ${CMAKE_COMMAND} -E copy_directory
		${R_CREATE_PACKAGE_TARGET_SOURCE_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/inst/include 
		${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/inst/include
			COMMAND ${CMAKE_COMMAND} -E copy_directory
		${R_CREATE_PACKAGE_TARGET_SOURCE_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/tests 
		${R_CREATE_PACKAGE_TARGET_BUILD_DIRECTORY}/${R_CREATE_PACKAGE_TARGET_PACKAGE}/tests
	)
